...
enum class ComponeIconButtonStyle {
    Normal, Filled, FilledTonal, Outlined
}

@Composable
fun ComponeIconButton(
    modifier: Modifier = Modifier,
    onClick: () -> Unit,
    painter: Painter,
    tint: Color? = null,
    style: ComponeIconButtonStyle = ComponeIconButtonStyle.Normal,
    ...
    val iconButton: @Composable (modifier: Modifier) -> Unit = {
        ...
        when (style) {
            ComponeIconButtonStyle.Normal -> IconButton(
                modifier = it,
                onClick = onClick,
                enabled = enabled,
            ...
            ComponeIconButtonStyle.Filled -> FilledIconButton(
                modifier = it,
                onClick = onClick,
                enabled = enabled,
            ...
            ComponeIconButtonStyle.FilledTonal -> FilledTonalIconButton(
                modifier = it,
                onClick = onClick,
                enabled = enabled,
            ...
            ComponeIconButtonStyle.Outlined -> OutlinedIconButton(
                modifier = it,
                onClick = onClick,
                enabled = enabled,
