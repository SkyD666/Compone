...
enum class ComponeFloatingActionButtonStyle {
    Normal, Extended, Large, Small
}

@Composable
fun ComponeFloatingActionButton(
    modifier: Modifier = Modifier,
    onClick: () -> Unit,
    onSizeWithSinglePaddingChanged: ((width: Dp, height: Dp) -> Unit)? = null,
    elevation: FloatingActionButtonElevation = FloatingActionButtonDefaults.elevation(),
    style: ComponeFloatingActionButtonStyle = ComponeFloatingActionButtonStyle.Normal,
    ...
    val floatingActionButton: @Composable (modifier: Modifier) -> Unit = {
        ...
        when (style) {
            ComponeFloatingActionButtonStyle.Normal -> FloatingActionButton(
            ...
            ComponeFloatingActionButtonStyle.Extended -> ExtendedFloatingActionButton(
                modifier = newModifier,
                onClick = onClick,
                elevation = elevation,
                interactionSource = interactionSource,
            ...
            ComponeFloatingActionButtonStyle.Large -> LargeFloatingActionButton(
                modifier = newModifier,
                onClick = onClick,
                elevation = elevation,
                interactionSource = interactionSource,
            ...
            ComponeFloatingActionButtonStyle.Small -> SmallFloatingActionButton(
                modifier = newModifier,
                onClick = onClick,
                elevation = elevation,
                interactionSource = interactionSource,
